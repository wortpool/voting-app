...
const PostItem = ({post: {owner, title, link, answer_count, score, is_answered, tags, view_count }, setIsActive, dark}) => {
    return ( 
        <div className="h-[100px] w-full border-b-2 border-b-orange flex px-6 py-[10px]">
            ...
            <div className="flex flex-col justify-around ml-4 max-w-[550px] w-full">
                <Link to={link} className="text-white">{truncateText(title, 70)}</Link>
                <div className="flex">
